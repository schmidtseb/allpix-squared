...
#ifndef ALLPIX_MODULE_GEOMETRY_CONSTRUCTION_DETECTOR_CONSTRUCTION_CUSTOM_H
#define ALLPIX_MODULE_GEOMETRY_CONSTRUCTION_DETECTOR_CONSTRUCTION_CUSTOM_H
...
namespace allpix {
     ...
     */
    class GeometryConstructionCustomG4 : public G4VUserDetectorConstruction {
    public:
        /**
         ...
         */
        GeometryConstructionCustomG4(GeometryManager* geo_manager, Configuration& config);
    ...
    private:
        ...
        /**
         * @brief Build a phantom
         */
        void build_phantom(G4ThreeVector, G4ThreeVector);
        void build_source(double, double, G4ThreeVector);
